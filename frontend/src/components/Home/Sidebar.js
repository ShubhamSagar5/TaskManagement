...
const Sidebar = () => {
  ...
  const handleLogout = async() => {
    try {
      ...
      const res = await axios.get("https://taskmanagement-tavq.onrender.com/api/v1/logout") 
 ...
 dispatch(setLoading(false))
  ...
  const fetchUserDetails = async () => {
    try {
      ...
      const userData = await axios.post('https://taskmanagement-tavq.onrender.com/api/v1/getInfo',{id:id},{
        headers:{
